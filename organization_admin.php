...
<main class="ex-shell ex-page">
    ...
    <div class="ex-admin-grid">
        <section class="ex-card">
            ...
            <div class="ex-table-wrap"><table class="ex-table"><thead><tr><th>코드</th><th>회사명</th><th>색상</th></tr></thead><tbody><?php foreach($companies as $company): ?><tr><td><span class="ex-badge"><?= smw_h($company['code']) ?></span></td><td><strong><?= smw_h($company['name']) ?></strong></td><td><span style="display:inline-block;width:10px;height:10px;border-radius:50%;background:<?= smw_h($company['color']) ?>"></span> <?= smw_h($company['color']) ?></td></tr><?php endforeach; ?></tbody></table></div>
        </section>
        <section class="ex-card">
    ...
    <div class="ex-admin-grid">
        <section class="ex-card">
            ...
            <?php if(empty($departments)): ?><div class="ex-empty">등록된 사업부가 없습니다.</div><?php else: ?><div class="ex-table-wrap"><table class="ex-table"><thead><tr><th>회사</th><th>사업부</th><th>상위 부서</th></tr></thead><tbody><?php foreach($departments as $department): ?><tr><td><?= smw_h($department['company_name']) ?></td><td><strong><?= smw_h($department['name']) ?></strong></td><td><?= smw_h($department['parent_name'] ?: '-') ?></td></tr><?php endforeach; ?></tbody></table></div><?php endif; ?>
        </section>
        <section class="ex-card">
    ...
    <div class="ex-admin-grid">
        <section class="ex-card">
            ...
            <?php if(empty($approvals)): ?><div class="ex-empty">등록된 결재선이 없습니다.</div><?php else: ?><div class="ex-table-wrap"><table class="ex-table"><thead><tr><th>결재선</th><th>1차</th><th>2차</th><th>3차</th></tr></thead><tbody><?php foreach($approvals as $approval): ?><tr><td><strong><?= smw_h($approval['name']) ?></strong></td><td><?= smw_h($approval['step1_name'] ?: '-') ?></td><td><?= smw_h($approval['step2_name'] ?: '-') ?></td><td><?= smw_h($approval['step3_name'] ?: '-') ?></td></tr><?php endforeach; ?></tbody></table></div><?php endif; ?>
        </section>
        <section class="ex-card">
